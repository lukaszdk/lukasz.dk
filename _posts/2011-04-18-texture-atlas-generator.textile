...
Get it on GitHub : "Texture Atlas Generator":http://github.com/lukaszbruun/texture-atlas-generator
...
pre. java AtlasGenerator atlas-2048- 2048 2048 abuse-png/
...
If the images cannot fit into one atlas of the specified size, then multiple atlases will be generated. The images below show the 3 atlases generated for the PNGs when setting
...
Here are the .txt files for the 3 images above.

* "atlas-1024-1.txt":/files/atlas-1024-1.txt
* "atlas-1024-2.txt":/files/atlas-1024-2.txt
* "atlas-1024-3.txt":/files/atlas-1024-3.txt
